function [mu, sigma, rou, AEPE,Energy] = gqmap_gpuSuper_mix(options,I1,I2,GRDT)
...
toc;
    function [da,du1,du2,do1,do2,dp,Ei] = node_grad_spectral(u1,u2,o1,o2,p,m,n)
...
%       if (m<=rg||m>M-rg||n<=rg||n>N-rg),return;end
    ...
    function [da,du1,du2,do1,do2,dp,Ei] = edge_grad_spectral(u1,u2,o1,o2,p)
        du1 = 0; du2 = 0; do1 = 0; do2 = 0; dp = 0; Ei=0;
        s = (sqrt(1+p)+sqrt(1-p))/2;
        t = (sqrt(1+p)-sqrt(1-p))/2;
        pr = 1 - p^2; sqrtpr = sqrt(pr);
